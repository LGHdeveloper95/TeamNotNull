  ...
  <div id="container">
            ...
            <tr>
              ...
              <td>
                ...
                <c:choose>
                  ...
                  <c:when test="${resume.pass_code == 2 }">
      ...
      <div id="bookmarkTable" class="listtable">
        <table>
          ...
          <c:forEach items="${bookList}" var="book">
            <tr>
              <td><a href="/Gusik/View?resnum=${book.resnum}">${book.restitle}</a></td>
              <td>${book.scrap_date}</td>
              <td><a href="/ComMyPage/DeleteBook?bmid=${book.bmid}">삭제</a></td>
            </tr>
          </c:forEach>
          </tbody>
        </table>
    ...
    <div class="profile">
      ...
      <div style="margin-top: 10px;">
        ...
        <button id="leave" class="btn">회원탈퇴</button>
      </div>
    </div>
  </div>
</main>
<script>
  ...
  let delcomid = '<c:out value="${sessionScope.comid}"/> '; //session에서 받아온 userid 들고옴
  ...
  leaveEl.addEventListener('click', function(){
    ...
    if(result){
      window.location = '/ComMyPage/DeleteCom?comid='+delcomid;
    }
  })
</script>
