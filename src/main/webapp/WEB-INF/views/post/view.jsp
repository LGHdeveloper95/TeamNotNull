    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td>
                    <a class = "btn btn-light" href="/Post/Board">목록</a>
                    <c:if test="${sessionScope.comid eq post.comid}">
                        <a class = "btn btn-light"  href="/Post/UpdateForm?recnum=${post.recnum}">수정 </a>
                        <a class = "btn btn-light"  href="/Post/Delete?recnum=${post.recnum}">삭제 </a>
                    </c:if>
                </td>
            </tr>
            </thead>
            ...
            <tr>
                ...
                <td style="text-align: center"> 마감일 ${post.deadline}</td>
            </tr>
            <tr>
                <td>기업 이름</td>
                <td>${ com.comname } </td>
                <td rowspan="4" style="text-align: center; width:300px;border-left: 2px solid #ccc"><img src="/${post.image_path}" alt="pic"/></td>
            </tr>
            <tr>
                <td>대표자</td>
                <td>${com.boss}</td>
