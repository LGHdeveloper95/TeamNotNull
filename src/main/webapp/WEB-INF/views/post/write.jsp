...
<main>
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <c:if test="${sessionScope.comid eq com.comid}">
                        <input type="submit" class="btn btn-light" value="제출">
                    </c:if>
                </td>
            </tr>
            </thead>
            ...
            <tr>
                <td rowspan="4" style="max-width: 130px; text-align: center;"><img src="${com.image_path}" alt="pic" style="width: 80%;"/></td>
                <td>기업 이름</td>
                <td>${ com.comname } </td>
            </tr>
            <tr>
